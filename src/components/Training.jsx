        ...
        <div className="mx-auto max-w-7xl">
          ...
          >
            ...
            <div className="relative grid gap-10 p-8 sm:p-12 lg:grid-cols-[220px_1fr] lg:gap-12">
              ...
              <div className="border-b border-white/10 pb-8 lg:border-b-0 lg:border-r lg:pb-0 lg:pr-8">
                <span className="rounded-full border border-cyan-400/30 bg-cyan-400/10 px-3 py-1 text-xs font-semibold text-cyan-300 font-mono">
                  SUMMER 2026
                </span>
                ...
                <div className="mt-8 rounded-2xl border border-cyan-400/20 bg-cyan-950/30 p-4">
              ...
              <div>
                <span className="text-xs uppercase tracking-wider text-cyan-300 font-mono">
                  Capstone Project
                </span>
                ...
                <div className="mt-6 grid grid-cols-2 gap-3 sm:grid-cols-4">
                  <div className="rounded-2xl border border-white/10 bg-black/30 p-4 backdrop-blur-md">
                    <p className="font-mono text-2xl font-bold text-white">421K+</p>
                  ...
                  <div className="rounded-2xl border border-white/10 bg-black/30 p-4 backdrop-blur-md">
                    <p className="font-mono text-2xl font-bold text-cyan-300">12 Wks</p>
                    <p className="mt-1 text-[10px] uppercase tracking-wider text-slate-500">
                      Forecast Horizon
                    </p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-white/10 bg-black/30 p-4 backdrop-blur-md">
                    <p className="font-mono text-2xl font-bold text-white">45</p>
                    <p className="mt-1 text-[10px] uppercase tracking-wider text-slate-500">
                      Retail Stores
                    </p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-white/10 bg-black/30 p-4 backdrop-blur-md">
                    <p className="font-mono text-2xl font-bold text-cyan-300">5.6%</p>
                    <p className="mt-1 text-[10px] uppercase tracking-wider text-slate-500">
                      Anomaly Outliers
                    </p>
                  </div>
                  ...
                  {viewMode === 'svg' ? (
                    <div className="relative mt-4">
                      ...
                      >
                        ...
                        <text x="440" y="45" fill="#22d3ee" fontSize="10" fontFamily="monospace">Prophet Forecast Horizon ➔</text>
                      </svg>
                    </div>
                  ) : (
                ...
                <div className="mt-7 flex flex-wrap gap-2">
                  {[
                    ...
                    <span
                      key={tech}
                      className="rounded-full border border-white/10 bg-black/20 px-3.5 py-1 text-xs text-slate-300"
                    >
                      {tech}
                    </span>
                  ))}
                ...
                <div className="mt-9 flex flex-wrap items-center gap-3">
                  <button
                    ...
                    className="flex items-center gap-2 rounded-xl border border-cyan-400/40 bg-gradient-to-r from-cyan-400/20 via-blue-500/20 to-purple-500/20 px-5 py-3 text-xs font-semibold text-cyan-200 shadow-[0_0_20px_rgba(34,211,238,0.15)] transition-all hover:border-cyan-300 hover:scale-105 active:scale-95"
                  >
                    <span>✦</span>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="group/demo flex items-center gap-2 rounded-xl bg-white px-5 py-3 text-xs font-semibold text-slate-950 transition-all hover:bg-slate-100 hover:scale-105 active:scale-95"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center gap-2 rounded-xl border border-white/15 bg-white/5 px-5 py-3 text-xs font-medium text-slate-200 backdrop-blur-sm transition-all hover:border-white/30 hover:bg-white/10"
                  >
                    <svg
        ...
        {certModalOpen && (
          ...
          >
            <motion.div
              ...
              className="relative flex h-[88vh] w-full max-w-4xl flex-col overflow-hidden rounded-3xl border border-cyan-400/30 bg-[#060b18] shadow-2xl shadow-cyan-500/10"
            >
              {/* Modal Topbar */}
              <div className="flex items-center justify-between border-b border-white/10 px-6 py-4">
                ...
                <div className="flex items-center gap-2">
                  <a
                    ...
                    className="flex items-center gap-1.5 rounded-lg border border-cyan-400/40 bg-cyan-400/10 px-3 py-1.5 text-xs font-medium text-cyan-200 transition-all hover:bg-cyan-400/20"
                  >
              ...
              {/* Modal Footer */}
              <div className="flex items-center justify-between border-t border-white/10 bg-[#040711] px-6 py-3 text-xs text-slate-500">
